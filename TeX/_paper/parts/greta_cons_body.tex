...
% general intro 
Fridays for Future (henceforth FFF) is a global social movement consisting to a large extent of school students that claim comprehensive, fast, and efficient measures for climate protection. The students skip schools, mostly on Fridays, to lay emphasis on their key demand: to adhere to the targets set in the 2015 Paris agreement to lower global carbon dioxide emissions in order to limit the associated increase in global warming to 1.5 degrees above pre-industrial levels. The movement is organized local chapters that plan weekly school strikes for the climate and regular large-scale coordinated marches \citep{smith2019window}. 

%Greta Thunberg
The movement received its initial impulse from Greta Thunberg, the then 15-year old Swedish teenager, who started her \textit{Skolstrejk för klimatet} (school strike for climate) in front of the Swedish parliament in August 2018. Her actions received quickly media attention around the world and Greta Thunberg soon started to advocate her goals at big international events such as the 2018 Climate Change Conference in Katowice, the World Economic Forum in Davos in January 2019, in front of the European Parliament on April 16, or the UN climate change conference in Madrid in December 2019. She sailed across the Atlantic to deliver her famous speech at the UN Climate Action summit in New York in September 2019 (`how dare you?'). Her person is tightly related to the movement's success.

Her person important for the success of the movement 
not only influence on the world stage but also locally
`The Greta Effect' (e.g. The Guardian 
-https://www.theguardian.com/environment/2019/nov/08/greta-thunberg-effect-driving-growth-in-carbon-offsetting
-> carbon offsetting
-> strike participation
-> Reduzierung von Flugreisen in Schweden
 verhalten: economist https://www.economist.com/graphic-detail/2019/08/19/the-greta-effect

 
viele Preise für ihr engagement 
...
In Germany, the first strikes started in mid December in few cities \citep{sommer2019fridays}. 

On March 1 and March 29 
 ...
 - einfluss auf polit. Ebene
 - Ausblick 2020 -> Corona und andere Faktoren, brechen der Welle
...
\cite{smith2019window}
\cite{demoor2020protest}
\cite{sommer2019fridays}
...
\begin{landscape}
	\vspace*{\fill}
	\begin{figure}[H]\centering\caption{Important events surrounding FFF, perception in (social) media, and environmental awareness in 2019}
