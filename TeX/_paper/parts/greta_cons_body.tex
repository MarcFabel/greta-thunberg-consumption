...
\input{greta_cons_fig__alternative_strike_meaures_hh}
%--------------------------------------------
...
\input{greta_cons_fig__maps_greens_participation}
...
% contribution and bigger picture
...
%Furthermore, mass movements may be an effective means to increase incentives for politicians to implement policies aimed at mitigating climate change, which typically materialize the long-run. 

%The novel strategy may also be applied to other contexts in which movements and gatherings of large number of people matter, such as in political uprisings or revolutions. 

%It is, to the best of our knowledge, the first paper to study whether climate protest participation may have changed voting behavior towards more climate-oriented political parties.
