...
%--------------
\begin{figure}[H]\centering
	\caption{Time series of the number of articles about Greta Thunberg, 2019}
	\includegraphics[width=0.99\linewidth]{descriptive/greta_cons_greta_2019}
	\begin{minipage}{\linewidth}
		\scriptsize{\emph{Notes:} The orange line is from a moving average with window of 3 days}
	\end{minipage}
\end{figure}
%--------------
