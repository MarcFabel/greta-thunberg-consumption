	...
	*paths
	...
	qui keep if (mode == 4)  													// Train 4 & Road 3 & not categorized 1 		| (mode == 3)
...
********************************************************************************
	...
	*Poisson
	...
	qui save "$temp_data/greta_cons_soccer_ex_orig_post_est_train", replace
	
	use "$temp_data/greta_cons_soccer_ex_orig_post_est_train", clear