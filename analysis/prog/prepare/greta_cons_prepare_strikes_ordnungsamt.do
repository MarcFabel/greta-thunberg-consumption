...
********************************************************************************	
	...
	*qui save "$temp/strikes_ordnungsamt.dta", replace
	use "$temp/strikes_ordnungsamt.dta", clear
	...
	* mistakes I spotted
	replace g_lat = "49.473818" if municipality == "Fürth"
	replace g_lon = "10.994015" if municipality == "Fürth"
