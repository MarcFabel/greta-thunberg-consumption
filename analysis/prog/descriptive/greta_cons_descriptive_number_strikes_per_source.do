...
********************************************************************************
	...
	graph export "$graphs_paper/greta_cons_number_strikes_per_source_ALL_STRIKES.pdf", as(pdf) replace
	...
	* drop fff website
	...
	twoway line count date if source == 2, color(maroon)  || ///
		...
		tlabel(01jan2019 (61) 1dec2019, format(%tdm) ) ///
		tmtick(01feb2019 (61) 3dec2019) ///
		legend(label(1 "authorities") label(2 "social media")  pos(11) ring(0) col(1) ///
		 order(1 2) region(color(none)) size(small)) || ///
			pcarrowi 130 21600 116 21620 (11) "15.03." , color(black) || ///
			pcarrowi 150 21670 136 21690 (11) "24.05." , color(black) || ///
			pcarrowi 240 21789 226 21809 (11) "20.09." , color(black) || ///
			pcarrowi 196 21859 182 21879 (11) "29.11." , color(black)
			
	graph export "$graphs_paper/greta_cons_number_strikes_per_source_limit.pdf", as(pdf) replace	
